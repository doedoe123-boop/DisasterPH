      ...
      <div className="p-3 space-y-3">
        ...
        {permission === "denied" ? (
          ...
          <div className="flex items-center justify-between">
            <span className="text-[12px] text-white">Push alerts active</span>
            <button
        ...
        {isActive && (
          <div className="space-y-2 border-t border-white/6 pt-2.5">
            {/* Severity threshold */}
            <div>
                ...
                <button
                  className={`flex-1 rounded border px-2 py-1 text-[11px] font-medium transition ${
                    prefs.minSeverity === "warning"
                      ...
                      : "border-white/8 bg-white/[0.03] text-[var(--text-dim)] hover:bg-white/[0.06]"
                  }`}
    ...
    >
      ...
      <span
        className={`flex h-4 w-7 items-center rounded-full transition ${
          checked ? "bg-cyan-400/40" : "bg-white/10"
        }`}
      >
        <span
