...
export function FloatingIncidentCard({ incident }: FloatingIncidentCardProps) {
  return (
    <div className="absolute bottom-4 left-4 z-20 hidden w-72 rounded-xl border border-white/10 bg-[rgba(4,11,19,0.92)] p-3 shadow-[0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-lg lg:block">
