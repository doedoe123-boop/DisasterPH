...
import { localizePrepTip, type PrepTip } from "@/lib/prep-guidance";
...
export function PrepGuidance({
  ...
  const localizedTips = visibleTips.map((tip) =>
    localizePrepTip(tip, locale),
  );
          ...
          return (
            ...
            >
              <div className="flex items-center gap-1.5">
                ...
                >
                  {i18n.prepUrgency[tip.urgency] ?? style.label}
                </span>
              </div>
