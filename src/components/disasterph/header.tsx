...
const NAV_ITEMS = [
  { label: "Disaster PH", sub: "Live Monitoring", href: "/", icon: Shield },
...
export function AppHeader() {
  ...
  return (
    <header className="flex items-center justify-between border-b border-white/10 bg-[var(--bg-panel-strong)] px-5 py-2.5">
      {/* ── Left: Logo / branding ── */}
