...
export function ArchiveTimeline({ events }: ArchiveTimelineProps) {
  return (
    <div className="relative pl-6">
      {/* Vertical line */}
      <div className="absolute left-[7px] top-2 bottom-2 w-px bg-overlay/10" />
      ...
      <div className="space-y-6">
        {events.map((entry, i) => (
          ...
          >
            ...
            <div
              className={`absolute -left-6 top-1.5 h-3 w-3 rounded-full border-2 ${
                i === 0
                  ...
                  : "border-overlay/20 bg-[var(--bg-panel)]"
              }`}
            />
            ...
            <h4 className="mt-1 text-sm font-bold text-[var(--text-primary)]">{entry.title}</h4>
