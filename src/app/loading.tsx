...
export default function Loading() {
  return (
    <main className="h-screen overflow-hidden bg-[var(--bg-base)] p-2 text-[var(--text-primary)]">
      <div className="mx-auto flex h-full max-w-[1600px] flex-col gap-2 rounded-lg border border-white/8 bg-[rgba(6,14,22,0.95)] p-2 shadow-[0_4px_24px_rgba(0,0,0,0.35)]">
        {/* ── Top bar skeleton ── */}
        <div className="rounded-lg border border-white/8 bg-[var(--bg-panel)] overflow-hidden">
          ...
          {/* Source strip */}
          <div className="flex items-center gap-4 border-b border-white/6 px-4 py-1.5">
            {sources.map((src) => (
          ...
          <div className="flex items-center gap-3 px-4 py-2">
            ...
            <div className="ml-4 flex gap-1.5">
              {["All", "Typhoon", "Flood", "Earthquake", "Volcano"].map((f) => (
                <div
                  key={f}
                  className="rounded-full border border-white/8 bg-white/[0.02] px-3 py-1"
                >
        ...
        <div className="grid min-h-0 flex-1 gap-2 lg:grid-cols-[48px_minmax(0,1fr)_340px]">
          ...
          <aside className="hidden rounded-lg border border-white/8 bg-[var(--bg-panel)] lg:flex lg:flex-col lg:items-center lg:gap-3 lg:py-3">
            <div className="loading-shimmer h-6 w-6 rounded-lg" />
            <div className="mx-auto h-px w-5 bg-white/8" />
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
          ...
          <section className="relative min-h-0 overflow-hidden rounded-lg border border-white/8">
            <div className="absolute inset-0 bg-[#040d16]">
              {/* Grid texture */}
              <div
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <div className="flex flex-col items-center gap-4 rounded-lg border border-white/8 bg-[rgba(6,14,22,0.92)] px-8 py-6">
          ...
          <aside className="hidden flex-col gap-2 lg:flex">
            ...
            <div className="rounded-lg border border-white/8 bg-[var(--bg-panel)] p-3">
            ...
            <div className="rounded-lg border border-white/8 bg-[var(--bg-panel)]">
              ...
              <div className="space-y-1 p-2">
                {[...Array(2)].map((_, i) => (
                  <div
                    key={i}
                    className="rounded-lg border-l-2 border-l-white/10 bg-white/[0.02] p-2.5"
                  >
            ...
            {/* Feed skeleton */}
            <div className="flex-1 rounded-lg border border-white/8 bg-[var(--bg-panel)]">
              <div className="flex items-center justify-between border-b border-white/8 px-3 py-2">
            ...
            {/* Status bar skeleton */}
            <div className="flex items-center gap-2 rounded-lg border border-white/8 bg-[var(--bg-panel)] px-2.5 py-1.5">
              <span className="h-1.5 w-1.5 rounded-full bg-emerald-400/40 pulse-dot" />
